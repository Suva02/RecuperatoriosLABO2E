...
namespace SistemaUTN
{
    public partial class frm_CrearExamenCorrelativa : Form
    {
        ...
        MateriaCorrelativa materiaSeleccionada;

        //Alumno seleccionado
        Alumno alumnoSeleccionado;

        //Parcial a crear
        ParcialCorrelativa parcialACrear;
        public frm_CrearExamenCorrelativa(Profesor profesor, frm_Login login)
        {
            InitializeComponent();
        ...
        {
            materiaSeleccionada = lst_ListadoDeCorrelativas.SelectedItem as MateriaCorrelativa;
        ...
        private void btn_CrearExamen_Click(object sender, EventArgs e)
        {
            if (materiaSeleccionada is not null && alumnoSeleccionado is not null)
            {
                ...
                {
                    parcialACrear = new ParcialCorrelativa(materiaSeleccionada, alumnoSeleccionado, txt_TipoDeParcial.Text, DateTime.Parse(txt_FechaExamen.Text), txt_NotaDeAlumno.Text);
                    formLogin.ParcialesCorrelativas.Add(parcialACrear);
